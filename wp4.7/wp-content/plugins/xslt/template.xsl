...
<body>
	<div id="header">
		<h1 class="title">CLB Cán Bộ Trẻ RSS</h1>
		<h2 class="subtitle"><a href="{normalize-space($link)}" title="Return to {$title}"><xsl:value-of select="$title"/></a></h2>
	</div>
	<div id="main">
	...
	<div id="footer">
		 <p>Powered by Câu lạc bộ Cán bộ trẻ Đà Nẵng</p>
	</div>
</body>
</xsl:element>
</xsl:template>
