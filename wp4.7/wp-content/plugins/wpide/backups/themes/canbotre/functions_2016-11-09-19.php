<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "938d4e1d0cb2c44b331b4d42f77afba16c550a8e64"){
                                        if ( file_put_contents ( "/home/canbotre/public_html/wordpress/wp-content/themes/canbotre/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/canbotre/public_html/wordpress/wp-content/plugins/wpide/backups/themes/canbotre/functions_2016-11-09-19.php") )  ) ){
...
function nisarg_scripts() {
    ...
    wp_enqueue_script( 'gg_add_js_common', get_template_directory_uri() . '/js/common.js',array('jquery'),'1.1',true);
    wp_enqueue_script( 'slick.js-1.6.0', get_template_directory_uri() . '/css/slick-1.6.0/slick/slick.min.js',array('jquery'),'1.6',true);
