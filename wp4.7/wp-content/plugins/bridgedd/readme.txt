...
Donate link: http://bridgedd.com/subscribe/
Tags: bridge,integration,phpbb
Requires at least: 3.7
Tested up to: 4.5
Stable tag: trunk

BridgeDD creates a stable, resource-light bridge between WordPress and phpBB3.0.
...
You can obtain support by visiting the [**BridgeDD support board**](http://bridgedd.com/support/index.php)
...
> ### BridgeDD PRO supports phpBB 3.1 and will support phpBB 3.2 upon its release. <br />
>
> &nbsp;

== Installation ==

> ### Read the [READ ME FIRST](http://bridgedd.com/read-me-first/) guide before installing BridgeDD! <br />
>
> &nbsp;

BridgeDD requires WordPress 3.7 or later (Multisite **not** supported), phpBB 3.0.9 - 3.0.14, PHP 5.3.0 or later, and the **mysqli** (Improved MySQL) PHP extension. This extension is bundled into PHP by default, and unless you have disabled it manually, it will be available.
...
> 2. If a bridge plugin such as _WP-United_ or _wp-phpbb-bridge_ is activated, follow its instructions to **disable it in phpBB and WordPress**
...
> 5. Select your phpBB installation in BridgeDD Settings, and _verify that the phpBB displayed URL and board preview are correct_
> 6. Also _verify that you are logged in to the phpBB board_. Then click **Save Changes**
> 7. Set the BridgeDD settings options as required, then click **Save Changes** again

== Frequently Asked Questions ==

> The [**READ ME FIRST**](http://bridgedd.com/read-me-first/) guide contains important information about compatibility of various plugins/MODs/etc with BridgeDD.

= BridgeDD doesn't work. =
Make sure to download and activate the [**BridgeDD Requirements plugin**](http://plugins.svn.wordpress.org/bridgedd/tags/public/bridgedd-require.zip).
...
The WordPress and phpBB installations must be in the same domain, and WordPress must be able to save a cookie that phpBB can read. BridgeDD will not work if, for example, WordPress is installed at **http://mywp.com** and phpBB is installed at **http://myforum.com**

### Got more questions?
Ask them at the [**BridgeDD support board**](http://bridgedd.com/support/index.php).

== Changelog ==

= 1.4 =
* Complete rewrite of installation and user integration code to resolve numerous longstanding issues
* WordPress requirement now 3.7
...
= 1.4 =
### BridgeDD 1.4 is a MANDATORY update!

BridgeDD 1.4 is a complete rewrite of the BridgeDD internals and fixes many installation and user integration issues.
...
== Translations ==
<br />
If you have translated this plugin into your language, feel free to post the PO file on the [**BridgeDD support board**](http://bridgedd.com/support/index.php).
